...
export default class ValidationHelper {
    ...
    static TextValidator = new RegExp(/^[a-zA-Zа-яёА-ЯЁ]+(([',. -][a-zA-Zа-яёА-ЯЁ])?[a-zA-Zа-яёА-ЯЁ]*)*$/);
    ...
    static validateSignupForm = Yup.object().shape({
        ...
        username: Yup.string().required("Username is required").max(1024, "Username is too long").matches(ValidationHelper.UsernameValidator, "Invalid username"),
